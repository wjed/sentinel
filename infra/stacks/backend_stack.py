    ...
    def __init__(
        ...
        **kwargs,
        ...
        user_data.add_commands(
            ...
            # ALB already authenticates via Cognito — TheHive trusts the ALB header
            'auth {',
            '  providers: [',
            '    {',
            '      name: header',
            ...
            "      # ALB does Cognito auth — Grafana trusts the ALB identity header",
