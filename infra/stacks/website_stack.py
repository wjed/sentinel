...
class WebsiteStack(Stack):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # ACM certificate for app.sentinelnetsolutions.com (for HTTPS via CloudFront)
        certificate = acm.Certificate(
            self,
            "SiteCertificate",
            domain_name="app.sentinelnetsolutions.com",
            validation=acm.CertificateValidation.from_dns(zone)  # CloudFront requires cert in us-east-1
        )
...
"""
        ...
        self.distribution = cloudfront.Distribution(
            ...
            domain_names=["app.sentinelnetsolutions.com"],
        ...
        route53.ARecord(
            ...
            "AppAliasRecord",
            zone=zone,
            record_name="app",  # makes app.sentinelnetsolutions.com
            target=route53.RecordTarget.from_alias(
                route53_targets.CloudFrontTarget(self.distribution)
            ),
        )
        website_url = f"https://app.sentinelnetsolutions.com"
