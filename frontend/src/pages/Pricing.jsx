export default function Pricing() {
  const tiers = [
    ...
    { name: 'Professional', price: 'Contact us', features: ['Everything in Starter', 'Case management', 'Honeypot analytics', 'SLA & priority support'], cta: 'Contact sales' },
      ...
      <div className="pricing-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.25rem' }}>
        {tiers.map((tier) => (
          ...
          >
            ...
            <button type="button" className="btn-secondary" style={{ width: '100%', padding: '0.55rem' }}>
              {tier.cta}
            </button>
          </div>
        ))}
