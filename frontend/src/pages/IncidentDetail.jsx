...
export default function IncidentDetail() {
  ...
  return (
    <div className="page">
      ...
      {/* Case summary header */}
      <div style={{ padding: '1rem', background: 'var(--surface-card)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', marginBottom: '1.5rem' }}>
      ...
      <div className="incident-detail-grid" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 2fr) minmax(0, 1fr)', gap: '1.5rem' }}>
        <div>
          <section style={{ marginBottom: '1.5rem' }}>
            ...
            <div style={{ padding: '2rem', background: 'var(--surface-card)', border: '1px dashed var(--border)', borderRadius: 'var(--radius)', color: 'var(--text-muted)', textAlign: 'center' }}>
